...
void CSortMatrix<T>::Ins(T v)
{
    ...
    vec[n_elements] = v;
    expand(n_elements++/size_x);
    sort(vec,vec+n_elements);
...
//        current  = &map[n_elements/size_x];
        *((map[n_elements/size_x]) + n_elements%size_x) = vec[i];
        n_elements++;
    }
}
...
{
    CSortMatrix<int> sm;
    sm.Ins(82); sm.Ins(44); sm.Ins(52); sm.Ins(77); sm.Ins(46);
    sm.Ins(99); sm.Ins(26);sm.Ins(64); sm.Ins(10); sm.Ins(4);
    sm.Ins(33); sm.Ins(13); sm.Ins(81); sm.Ins(35);sm.Ins(17);
    sm.Ins(3); sm.Ins(20); sm.Ins(54); sm.Ins(73); sm.Ins(12);
    sm.Ins(92);
//    sm.Print();
